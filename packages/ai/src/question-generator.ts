...
Вопросы проверяют ФУНДАМЕНТАЛЬНЫЕ НАВЫКИ селлера — знания, которые применимы в повседневной работе на маркетплейсе. Хороший вопрос: "Какой показатель используется для оценки эффективности рекламы на Wildberries?" Плохой вопрос: "Что, по мнению автора, является ключевым фактором?"
...
- DRR (доля рекламных расходов) — основной термин эффективности рекламы, приоритетнее CPO
- CTR зависит от позиции в выдаче — если вопрос про CTR, учитывай этот контекст
- Аналитические данные сторонних сервисов — расчётные, не 100% точные. Используй формулировку "проверка" вместо "верификация"
...
❌ "Согласно материалам...", "На основании обсуждённой стратегии...", "Как показано в курсе..." — никаких ссылок на учебные материалы или курс
...
❌ Налоги, налоговые схемы, системы налогообложения — это тема для специализированных курсов, не для общей диагностики
❌ Маркировка товаров, требования к упаковке, этикетки — не ключевая компетенция для диагностики
...
- "Что входит в расчёт юнит-экономики товара на Wildberries?" (MEDIUM, фундаментальное знание)
- "Какой показатель отражает долю рекламных расходов в выручке?" (EASY, базовая метрика — DRR)
...
- "Селлер видит, что CTR карточки упал с 5% до 2%. Какое действие стоит предпринять первым?" (MEDIUM, практический кейс)
