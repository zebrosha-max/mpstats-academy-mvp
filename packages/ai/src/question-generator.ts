...
- Explanation объясняет почему ответ верен (2-3 предложения)
...
- "Какой показатель отражает долю рекламных расходов в выручке?" (EASY, базовая метрика)
- "При анализе ниши, какой параметр показывает уровень конкуренции?" (MEDIUM, аналитика)
