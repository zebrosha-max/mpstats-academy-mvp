...
❌ Вопросы про конкретные кнопки/интерфейс инструментов БЕЗ уточнения какого инструмента ("В каком разделе выбрать стратегию?" — КАКОГО инструмента?)
❌ Если упоминаешь инструмент (MPSTATS, автобиддер) — ОБЯЗАТЕЛЬНО укажи конкретный модуль/раздел ("В автобиддере MPSTATS какая стратегия...")
