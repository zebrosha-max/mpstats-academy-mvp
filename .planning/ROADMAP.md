...
- 🚧 **v1.1 Admin & Polish** — Phases 10-15 (in progress)
...
- [x] **Phase 15: Landing Redesign & Theme Toggle** — Новый лендинг (design-v4a light + design-v1 dark), toggle тем, премиальный вид (completed 2026-02-27)
...
**Goal:** Заменить текущий лендинг (app/page.tsx) на новый дизайн design-v4a (light) с возможностью переключения на тёмную тему (design-v1). Премиальный вид, SVG radar chart, dark CTA блок, toggle dark/light.
**Depends on:** Nothing (independent)
**Requirements:** LANDING-01, LANDING-02, LANDING-03
**Success Criteria** (what must be TRUE):
  1. Лендинг по умолчанию отображается в светлой теме (design-v4a) с премиальным видом
  2. Пользователь может переключить тему (dark/light) через toggle в навигации, и весь лендинг перерисовывается
...
- [x] 15-02-PLAN.md — Unified landing page с theme-aware CSS переменными + visual checkpoint
