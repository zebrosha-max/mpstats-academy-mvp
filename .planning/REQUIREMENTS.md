...
- [ ] **AUTH-01**: Пользователь может войти через Яндекс ID (серверный OAuth flow + Supabase Admin API)
...
- [ ] **AUTH-04**: OAuth архитектура расширяема для будущих провайдеров (Точка ID и др.)
