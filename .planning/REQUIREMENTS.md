...
- [x] **DEBT-02**: Кеширование AI-сгенерированных вопросов в БД для повторного использования
...
- [x] **LANDING-01**: Лендинг по умолчанию отображается в светлой теме (design-v4a) с премиальным видом
- [x] **LANDING-02**: Пользователь может переключить тему (dark/light) через toggle в навигации, тема сохраняется в localStorage
- [x] **LANDING-03**: CTA блок внизу страницы тёмный в обеих темах
