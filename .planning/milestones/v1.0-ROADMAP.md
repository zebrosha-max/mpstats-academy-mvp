...
- [x] **Phase 4: Access Control & Personalization** - Мягкое ограничение доступа и персонализированный трек (completed 2026-02-25)
- [x] **Phase 5: Security Hardening** - Защита endpoints, rate limiting, санитизация AI output (completed 2026-02-25)
...
- [x] 04-02-PLAN.md — "Мой трек" tab on /learn with smart defaults, progress bar, LessonCard recommendation badge
...
Plans:
- [x] 05-01-PLAN.md — Rate limit middleware, protectedProcedure on AI endpoints, server-only guards, CI leak detection
- [x] 05-02-PLAN.md — SafeMarkdown (react-markdown + rehype-sanitize), error boundaries, not-found page
...
| 4. Access Control | 2/2 | Complete | 2026-02-25 |
| 5. Security Hardening | 2/2 | Complete | 2026-02-25 |
