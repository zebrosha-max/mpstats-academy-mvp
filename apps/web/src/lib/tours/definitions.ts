...
export const learnSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      title: 'Секции трека',
      description: 'Уроки сгруппированы по приоритету: ошибки, углубление, развитие, продвинутый.',
    },
  },
  {
    element: '[data-tour="learn-add-to-track"]',
    popover: {
      title: 'Добавить в трек',
      description: 'Нажмите +, чтобы добавить любой урок в свой персональный трек.',
    },
  },
];
