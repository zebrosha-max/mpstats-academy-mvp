        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1.5">
              <span title="Вопросы, на которые вы ответили неверно в диагностике. Рекомендуем пересмотреть эти фрагменты урока.">
                <svg className="w-4 h-4 text-amber-600 flex-shrink-0 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
