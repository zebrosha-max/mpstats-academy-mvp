          ...
          <CardContent className="flex-1 flex flex-col min-h-0">
            ...
            <div className="pt-2 border-t border-mp-gray-200">
              ...
              <p className="mt-2 text-caption text-mp-gray-400 leading-snug">
                Я отвечаю на основе того, что говорит спикер в видео. На вопросы про то, что показано на экране (таблицы, ссылки, скриншоты), пока ответить не смогу — мы работаем над этим. По сложным вопросам напиши в комментарии под уроком — модератор подтянется.
              </p>
            </div>
          </CardContent>
        </Card>
